...
public abstract class SearchTask {
	...
	public void go(final String text, int direction, int displayPage, int searchPage) {
		...
		progressDialog.setTitle(EUExUtil.getString("plugin_uexpdfreader_searching_"));
			...
			protected void onPostExecute(SearchTaskResult result) {
				...
				if (result != null) {
					...
					mAlertBuilder.setTitle(
							SearchTaskResult.get() == null ? EUExUtil.getString("plugin_uexpdfreader_text_not_found")
									: EUExUtil.getString("plugin_uexpdfreader_no_further_occurrences_found"));
