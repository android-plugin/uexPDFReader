...
public class MuPDFPageView extends PageView implements MuPDFView {
	...
	public MuPDFPageView(Context c, FilePicker.FilePickerSupport filePickerSupport, MuPDFCore core, Point parentSize,
		...
		mTextEntryBuilder.setTitle(EUExUtil.getString("plugin_uexpdfreader_fill_out_text_field"));
		LayoutInflater inflater = (LayoutInflater) c.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		mEditText = (EditText) inflater.inflate(EUExUtil.getResLayoutID("plugin_uexpdfreader_textentry"), null);
		mTextEntryBuilder.setView(mEditText);
		mTextEntryBuilder.setNegativeButton(EUExUtil.getString("cancel"), new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int which) {
				dialog.dismiss();
			}
		});
		mTextEntryBuilder.setPositiveButton(EUExUtil.getString("confirm"), new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int which) {
		...
		mChoiceEntryBuilder.setTitle(EUExUtil.getString("plugin_uexpdfreader_choose_value"));

		mSigningDialogBuilder = new AlertDialog.Builder(c);
		mSigningDialogBuilder.setTitle("Select certificate and sign?");
		mSigningDialogBuilder.setNegativeButton(EUExUtil.getString("cancel"), new DialogInterface.OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
				dialog.dismiss();
			}
		});
		mSigningDialogBuilder.setPositiveButton(EUExUtil.getString("confirm"), new DialogInterface.OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
		...
		mSignatureReportBuilder.setPositiveButton(EUExUtil.getString("confirm"), new DialogInterface.OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
				dialog.dismiss();
			}
		...
		mPasswordEntryBuilder.setTitle(EUExUtil.getString("plugin_uexpdfreader_enter_password"));
		mPasswordEntryBuilder.setView(mPasswordText);
		mPasswordEntryBuilder.setNegativeButton(EUExUtil.getString("cancel"), new DialogInterface.OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
				dialog.dismiss();
			}
