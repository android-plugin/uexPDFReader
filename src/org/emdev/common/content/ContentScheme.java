...
//            final UIFileCopying ui = new UIFileCopying(R.string.msg_loading_book, 64 * 1024, progress);
        	 final UIFileCopying ui = new UIFileCopying(EUExUtil.getResStringID("plugin_pdf_msg_loading_book"), 64 * 1024, progress);
...
//            final UIFileCopying ui = new UIFileCopying(R.string.opds_loading_book, 64 * 1024, progress);
        	 final UIFileCopying ui = new UIFileCopying( EUExUtil.getResStringID("plugin_pdf_opds_loading_book"), 64 * 1024, progress);
