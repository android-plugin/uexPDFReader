...
//        super.setNegativeButton(android.R.string.cancel, actions.getOrCreateAction(R.id.actions_no_action));
    	 super.setNegativeButton(android.R.string.cancel, actions.getOrCreateAction(EUExUtil.getResIdID("actions_no_action")));
        return this;
    }
...
//        super.setNegativeButton(resId, actions.getOrCreateAction(R.id.actions_no_action));
    	super.setNegativeButton(resId, actions.getOrCreateAction(EUExUtil.getResIdID("actions_no_action")));
