...
//        actionLabels = context.getResources().getStringArray(R.array.list_actions_labels);
    	 actionIds = context.getResources().getStringArray(ResUtils.getResArrayId("plugin_pdf_list_actions_ids"));
         actionLabels = context.getResources().getStringArray(ResUtils.getResArrayId("plugin_pdf_list_actions_labels"));
    }
    ...
    {
//        final ViewHolder holder = BaseViewHolder.getOrCreateViewHolder(ViewHolder.class, R.layout.plugin_pdf_list_dropdown_item,
//                convertView, parent);

    	  final ViewHolder holder = BaseViewHolder.getOrCreateViewHolder(ViewHolder.class, EUExUtil.getResLayoutID("plugin_pdf_list_dropdown_item"),
                  convertView, parent);
...
//                convertView, parent);
    	final ViewHolder holder = BaseViewHolder.getOrCreateViewHolder(ViewHolder.class, EUExUtil.getResLayoutID("list_item"),
                convertView, parent);
...
//            this.textView = (TextView) convertView.findViewById(R.id.list_item);
            this.textView = (TextView) convertView.findViewById(EUExUtil.getResIdID("list_item"));
        }
    }
