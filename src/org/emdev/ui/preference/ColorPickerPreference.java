...
public class ColorPickerPreference extends DialogPreference implements ColorPickerView.OnColorChangedListener {
    ...
    public ColorPickerPreference(final Context context, final AttributeSet attrs) {
        super(context, attrs);
//        setWidgetLayoutResource(R.layout.plugin_pdf_color_picker_preference_widget);
        setWidgetLayoutResource(EUExUtil.getResLayoutID("plugin_pdf_color_picker_preference_widget"));
    }
...
//        View v = view.findViewById(R.id.color_picke_preference_view);
        View v = view.findViewById( EUExUtil.getResIdID("color_picke_preference_view"));
...
//        final View layout = inflater.inflate(R.layout.plugin_pdf_dialog_color_picker, null);
...
//        mNewColor = (ColorPanelView) layout.findViewById(R.id.new_color_panel);
        ...
        final View layout = inflater.inflate(EUExUtil.getResLayoutID("plugin_pdf_dialog_color_picker"), null);
        readColor(0x00FFFFFF);
        mColorPicker = (ColorPickerView) layout.findViewById( EUExUtil.getResIdID("color_picker_view"));
        mOldColor = (ColorPanelView) layout.findViewById( EUExUtil.getResIdID("old_color_panel"));
        mNewColor = (ColorPanelView) layout.findViewById( EUExUtil.getResIdID("new_color_panel"));
