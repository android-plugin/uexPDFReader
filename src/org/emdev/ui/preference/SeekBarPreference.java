...
//        final View view = inflater.inflate(R.layout.plugin_pdf_pref_seek_dialog, null);
//
//        try {
...
//        handler.init(new IViewContainer.ViewBridge(view), seekBar, R.id.pref_seek_bar_minus, R.id.pref_seek_bar_plus);
        ...
        final View view = inflater.inflate(EUExUtil.getResLayoutID("plugin_pdf_pref_seek_dialog"), null);
        ...
        ((TextView) view.findViewById(  EUExUtil.getResIdID("pref_seek_min_value"))).setText(Integer.toString(minValue));
        ((TextView) view.findViewById(  EUExUtil.getResIdID("pref_seek_max_value"))).setText(Integer.toString(maxValue));
      

        seekBar = (SeekBar) view.findViewById(  EUExUtil.getResIdID("pref_seek_bar"));
        seekBar.setMax(maxValue - minValue);
        seekBar.setProgress(currentValue - minValue);
        seekBar.setKeyProgressIncrement(1);
        seekBar.setOnSeekBarChangeListener(this);

        text = (TextView) view.findViewById(  EUExUtil.getResIdID("pref_seek_current_value"));
        text.setText(Integer.toString(currentValue));

        handler.init(new IViewContainer.ViewBridge(view), seekBar,   EUExUtil.getResIdID("pref_seek_bar_minus"),   EUExUtil.getResIdID("pref_seek_bar_plus"));
        return view;
    }
