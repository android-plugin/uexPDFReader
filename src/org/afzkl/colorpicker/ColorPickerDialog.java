...
//		View layout = inflater.inflate(R.layout.plugin_pdf_dialog_color_picker, null);
		View layout = inflater.inflate(EUExUtil.getResLayoutID("plugin_pdf_dialog_color_picker"), null);
...
//		mNewColor = (ColorPanelView) layout.findViewById(R.id.new_color_panel);
		...
		mColorPicker = (ColorPickerView) layout
				.findViewById(EUExUtil.getResIdID("color_picker_view"));
