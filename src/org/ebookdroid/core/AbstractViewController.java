...
//        createAction(R.id.actions_rightBottomCorner, new Constant("offsetX", 1), new Constant("offsetY", 1));
        ...
        createAction(EUExUtil.getResIdID("actions_verticalConfigScrollUp"), new Constant("direction", -1));
        createAction(EUExUtil.getResIdID("actions_verticalConfigScrollDown"), new Constant("direction", +1));
        createAction(EUExUtil.getResIdID("actions_leftTopCorner"), new Constant("offsetX", 0), new Constant("offsetY", 0));
        createAction(EUExUtil.getResIdID("actions_leftBottomCorner"), new Constant("offsetX", 0), new Constant("offsetY", 1));
        createAction(EUExUtil.getResIdID("actions_rightTopCorner"), new Constant("offsetX", 1), new Constant("offsetY", 0));
        createAction(EUExUtil.getResIdID("actions_rightBottomCorner"), new Constant("offsetX", 1), new Constant("offsetY", 1));
    }
