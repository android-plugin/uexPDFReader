...
//    SQUEEZER(R.string.pref_animation_type_squeezer, true);
	...
	NONE(EUExUtil.getResStringID("plugin_pdf_pref_animation_type_none"), true),

    CURLER(EUExUtil.getResStringID("plugin_pdf_pref_animation_type_curler_simple"), false),

    CURLER_DYNAMIC(EUExUtil.getResStringID("plugin_pdf_pref_animation_type_curler_dynamic"), false),

    SLIDER(EUExUtil.getResStringID("plugin_pdf_pref_animation_type_slider"), true),

    SLIDER2(EUExUtil.getResStringID("plugin_pdf_pref_animation_type_slider2"), true),

    FADER(EUExUtil.getResStringID("plugin_pdf_pref_animation_type_fader"), true),

    SQUEEZER(EUExUtil.getResStringID("plugin_pdf_pref_animation_type_squeezer"), true);
