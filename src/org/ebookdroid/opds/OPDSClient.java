...
//            progress.setProgressDialogMessage(R.string.opds_loading_catalog);
            progress.setProgressDialogMessage( EUExUtil.getResStringID("plugin_pdf_opds_loading_catalog"));
...
//                    final UIFileCopying worker = new UIFileCopying(R.string.opds_loading_book, 64 * 1024, progress);
                	 final UIFileCopying worker = new UIFileCopying(  EUExUtil.getResStringID("plugin_pdf_opds_loading_book"), 64 * 1024, progress);
...
//                        final UIFileCopying worker = new UIFileCopying(R.string.opds_unpacking_book, bufsize, progress);
                        final UIFileCopying worker = new UIFileCopying(EUExUtil.getResStringID("plugin_pdf_opds_unpacking_book"), bufsize, progress);
