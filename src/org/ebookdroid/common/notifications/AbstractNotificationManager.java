...
//        final CharSequence title = BaseDroidApp.context.getText(R.string.app_name);
    	final CharSequence title = BaseDroidApp.context.getText(EUExUtil.getResStringID("app_name"));
...
//        return notify(BaseDroidApp.context.getText(R.string.app_name), message, null);
    	 return notify(BaseDroidApp.context.getText( EUExUtil.getResStringID("app_name")), message, null);
