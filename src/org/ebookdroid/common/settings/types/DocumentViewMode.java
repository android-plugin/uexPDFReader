...
//    SINGLE_PAGE(R.string.pref_viewmode_single_page, null, SinglePageController.class);
	...
	VERTICALL_SCROLL(EUExUtil.getResStringID("plugin_pdf_pref_viewmode_vertical_scroll"), PageAlign.WIDTH, VScrollController.class),

    HORIZONTAL_SCROLL(EUExUtil.getResStringID("plugin_pdf_pref_viewmode_horizontal_scroll"), PageAlign.HEIGHT, HScrollController.class),

    SINGLE_PAGE(EUExUtil.getResStringID("plugin_pdf_pref_viewmode_single_page"), null, SinglePageController.class);
