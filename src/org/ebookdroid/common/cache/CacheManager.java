...
//            super(context, R.string.cache_moving_text, false);
        	 ...
        	 super(context, EUExUtil.getResStringID("plugin_pdf_cache_moving_text"), false);
        }
...
//            final String text = context.getResources().getString(R.string.cache_moving_progress, args);
        	  final String text = context.getResources().getString(EUExUtil.getResStringID("plugin_pdf_cache_moving_progress"), args);
