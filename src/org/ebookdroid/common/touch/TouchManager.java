...
//            }
            ...
            {
                final Region r = def.addRegion(0, 0, 100, 100);
                r.setAction(Touch.DoubleTap, EUExUtil.getResIdID("actions_openOptionsMenu"), true);
            }
            {
                final Region r = def.addRegion(80, 0, 100, 20);
                r.setAction(Touch.DoubleTap, EUExUtil.getResIdID("mainmenu_close"), true);
            }
            {
                final Region r = def.addRegion(0, 0, 100, 10);
                r.setAction(Touch.SingleTap, EUExUtil.getResIdID("actions_verticalConfigScrollUp"), true);
            }
            {
                final Region r = def.addRegion(0, 90, 100, 100);
                r.setAction(Touch.SingleTap, EUExUtil.getResIdID("actions_verticalConfigScrollDown"), true);
            }
