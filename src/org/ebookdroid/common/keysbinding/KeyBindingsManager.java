...
//            addAction(R.id.actions_verticalConfigScrollDown, KeyEvent.KEYCODE_DPAD_DOWN, KeyEvent.KEYCODE_VOLUME_DOWN);
        	 ...
        	 addAction(EUExUtil.getResIdID("actions_verticalConfigScrollUp"), KeyEvent.KEYCODE_DPAD_UP, KeyEvent.KEYCODE_VOLUME_UP);
             addAction(EUExUtil.getResIdID("actions_verticalConfigScrollDown"), KeyEvent.KEYCODE_DPAD_DOWN, KeyEvent.KEYCODE_VOLUME_DOWN);
