...
//        setContentView(R.layout.plugin_pdf_opds);
...
//        list = (ExpandableListView) findViewById(R.id.opdslist);
        list = (ExpandableListView) findViewById(EUExUtil.getResIdID("opdslist"));
...
//                        R.drawable.plugin_pdf_opds_menu_nav_up_enabled, R.drawable.plugin_pdf_opds_menu_nav_up_disabled);
//                ActionMenuHelper.setMenuItemEnabled(menu, canNext, R.id.opdsnextfolder,
//                        R.drawable.plugin_pdf_opds_menu_nav_next_enabled, R.drawable.plugin_pdf_opds_menu_nav_next_disabled);
//                ActionMenuHelper.setMenuItemEnabled(menu, canPrev, R.id.opdsprevfolder,
//                        R.drawable.plugin_pdf_opds_menu_nav_prev_enabled, R.drawable.plugin_pdf_opds_menu_nav_prev_disabled);
//            } else {
//                ActionMenuHelper.setMenuItemEnabled(menu, canUp, R.id.opdsupfolder,
//                        R.drawable.plugin_pdf_opds_actionbar_nav_up_enabled, R.drawable.plugin_pdf_opds_actionbar_nav_up_disabled);
//                ActionMenuHelper.setMenuItemEnabled(menu, canNext, R.id.opdsnextfolder,
//                        R.drawable.plugin_pdf_opds_actionbar_nav_next_enabled, R.drawable.plugin_pdf_opds_actionbar_nav_next_disabled);
//                ActionMenuHelper.setMenuItemEnabled(menu, canPrev, R.id.opdsprevfolder,
//                        R.drawable.plugin_pdf_opds_actionbar_nav_prev_enabled, R.drawable.plugin_pdf_opds_actionbar_nav_prev_disabled);
//            }
//        }
    }
...
//        findViewById(R.id.opdsaddfeed).setVisibility(feed != null ? View.GONE : View.VISIBLE);
        findViewById(EUExUtil.getResIdID("opdsaddfeed")).setVisibility(feed != null ? View.GONE : View.VISIBLE);
    }
