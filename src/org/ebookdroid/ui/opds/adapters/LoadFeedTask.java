...
//        super(adapter.context, R.string.opds_connecting, true);
    	 super(adapter.context, EUExUtil.getResStringID("plugin_pdf_opds_connecting"), true);
...
//            adapter.showErrorDlg(R.string.opdsrefreshfolder, R.id.opdsrefreshfolder, result, result.error);
        	adapter.showErrorDlg(EUExUtil.getResStringID("plugin_pdf_opdsrefreshfolder"), EUExUtil.getResIdID("opdsrefreshfolder"), result, result.error);
        }
