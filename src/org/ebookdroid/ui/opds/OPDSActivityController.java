...
//        final View childView = LayoutInflater.from(getManagedComponent()).inflate(R.layout.plugin_pdf_alias_url, null);
//
...
//        final EditText passwordEdit = (EditText) childView.findViewById(R.id.editPassword);
    	 ...
    	 final View childView = LayoutInflater.from(getManagedComponent()).inflate(EUExUtil.getResLayoutID("alias_url"), null);

         final ActionDialogBuilder builder = new ActionDialogBuilder(getManagedComponent(), this);
         builder.setTitle(EUExUtil.getResStringID("plugin_pdf_opds_addfeed_title"));
         builder.setMessage(EUExUtil.getResStringID("plugin_pdf_opds_addfeed_msg"));
         builder.setView(childView);

         final EditText aliasEdit = (EditText) childView.findViewById(EUExUtil.getResIdID("editAlias"));
         final EditText urlEdit = (EditText) childView.findViewById(EUExUtil.getResIdID("editURL"));
         final CheckBox authCheck = (CheckBox) childView.findViewById(EUExUtil.getResIdID("checkAuth"));
         final TextView loginText = (TextView) childView.findViewById(EUExUtil.getResIdID("textUsername"));
         final EditText loginEdit = (EditText) childView.findViewById(EUExUtil.getResIdID("editUsername"));
         final TextView passwordText = (TextView) childView.findViewById(EUExUtil.getResIdID("textPassword"));
         final EditText passwordEdit = (EditText) childView.findViewById(EUExUtil.getResIdID("editPassword"));
...
//        builder.show();
        ...
        builder.setPositiveButton(EUExUtil.getResStringID("plugin_pdf_opds_addfeed_ok"), EUExUtil.getResIdID("actions_addFeed"),
                new EditableValue("alias", aliasEdit), new EditableValue("url", urlEdit), new CheckableValue("auth",
                        authCheck), new EditableValue("login", loginEdit), new EditableValue("password", passwordEdit));
        builder.setNegativeButton();
        builder.show();
...
//        final EditText passwordEdit = (EditText) childView.findViewById(R.id.editPassword);
        ...
        final ActionDialogBuilder builder = new ActionDialogBuilder(getManagedComponent(), this);
        builder.setTitle( EUExUtil.getResStringID("plugin_pdf_opds_editfeed_title"));
        builder.setMessage(EUExUtil.getResStringID("plugin_pdf_opds_editfeed_msg"));
        builder.setView(childView);
...
//                        "feed", feed));
        builder.setPositiveButton( EUExUtil.getResStringID("plugin_pdf_opds_editfeed_ok"), EUExUtil.getResIdID("actions_editFeed"), new EditableValue("alias",
                aliasEdit), new EditableValue("url", urlEdit), new CheckableValue("auth", authCheck),
                new EditableValue("login", loginEdit), new EditableValue("password", passwordEdit), new Constant(
                        "feed", feed));
...
//        builder.show();
        ...
        final ActionDialogBuilder builder = new ActionDialogBuilder(getManagedComponent(), this);
        builder.setTitle(EUExUtil.getResStringID("plugin_pdf_opds_deletefeed_title"));
        builder.setMessage(EUExUtil.getResStringID("plugin_pdf_opds_deletefeed_msg"));
        builder.setPositiveButton(EUExUtil.getResStringID("plugin_pdf_opds_deletefeed_ok"),  EUExUtil.getResIdID("actions_deleteFeed"), new Constant("feed", feed));
        builder.setNegativeButton();
        builder.show();
...
//        final String rawType = getManagedComponent().getResources().getString(R.string.opds_downloading_dlg_raw_type);
        final String rawType = getManagedComponent().getResources().getString( EUExUtil.getResStringID("plugin_pdf_opds_downloading_dlg_raw_type"));
...
//            builder.setTitle(R.string.opds_downloading_dlg_title);
            builder.setTitle(EUExUtil.getResStringID("plugin_pdf_opds_downloading_dlg_title"));
            builder.setMessage(LengthUtils.safeString(target.type, rawType));
            builder.setPositiveButton( EUExUtil.getResIdID("actions_downloadBook"), new Constant("book", book), new Constant(
...
//        builder.setItems(items, getOrCreateAction(R.id.actions_downloadBook).putValue("book", book));
        builder.setTitle(  EUExUtil.getResStringID("plugin_pdf_opds_downloading_type_dlg_title"));
        builder.setItems(items, getOrCreateAction(EUExUtil.getResIdID("actions_downloadBook")).putValue("book", book));
        builder.show();
    }
