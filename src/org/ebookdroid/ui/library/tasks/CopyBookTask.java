...
//        super(context, R.string.book_copy_start, R.string.book_copy_complete, R.string.book_copy_error, false);
    	super(context,  EUExUtil.getResStringID("plugin_pdf_book_copy_start"),
    	        EUExUtil.getResStringID("plugin_pdf_book_copy_complete"),
    	        EUExUtil.getResStringID("plugin_pdf_book_copy_error"), false);
...
//            final UIFileCopying worker = new UIFileCopying(R.string.book_copy_progress, 256 * 1024, this);
        	final UIFileCopying worker = new UIFileCopying(   EUExUtil.getResStringID("plugin_pdf_book_copy_progress"), 256 * 1024, this);
