...
//        super(context, R.string.book_move_start, R.string.book_move_complete, R.string.book_move_error, false);
    	super(context,  EUExUtil.getResStringID("plugin_pdf_book_move_start"),
    	        EUExUtil.getResStringID("plugin_pdf_book_move_complete"),
    	        EUExUtil.getResStringID("plugin_pdf_book_move_error"), false);
