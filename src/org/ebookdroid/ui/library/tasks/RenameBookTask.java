...
//        super(context, R.string.book_move_start, R.string.book_move_complete, R.string.book_move_error, false);
    	super(context, EUExUtil.getResStringID("plugin_pdf_book_move_start"), EUExUtil.getResStringID("plugin_pdf_book_move_complete"), EUExUtil.getResStringID("plugin_pdf_book_move_error"), false);
...
//        final UIFileCopying worker = new UIFileCopying(R.string.opds_loading_book, 256 * 1024, this);
        final UIFileCopying worker = new UIFileCopying( EUExUtil.getResStringID("plugin_pdf_opds_loading_book"), 256 * 1024, this);
