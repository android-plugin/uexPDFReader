...
//        final ViewHolder holder = BaseViewHolder.getOrCreateViewHolder(ViewHolder.class, R.layout.plugin_pdf_recentitem, view,
//                parent);
    	final ViewHolder holder = BaseViewHolder.getOrCreateViewHolder(ViewHolder.class, EUExUtil.getResLayoutID("plugin_pdf_recentitem"), view,
                parent);
...
//        base.loadThumbnail(node.path, holder.imageView, R.drawable.plugin_pdf_recent_item_book);
        base.loadThumbnail(node.path, holder.imageView, EUExUtil.getResDrawableID("plugin_pdf_recent_item_book"));
...
//            fileSize = (TextView) convertView.findViewById(R.id.recentItemfileSize);
            ...
            name = (TextView) convertView.findViewById( EUExUtil.getResStringID("plugin_pdf_recentItemName"));
            imageView = (ImageView) convertView.findViewById( EUExUtil.getResStringID("plugin_pdf_recentItemIcon"));
            info = (TextView) convertView.findViewById( EUExUtil.getResStringID("plugin_pdf_recentItemInfo"));
            fileSize = (TextView) convertView.findViewById( EUExUtil.getResStringID("plugin_pdf_recentItemfileSize"));
