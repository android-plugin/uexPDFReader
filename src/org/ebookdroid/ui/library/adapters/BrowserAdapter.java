...
//        final ViewHolder holder = BaseViewHolder.getOrCreateViewHolder(ViewHolder.class, R.layout.plugin_pdf_browseritem, view,
//                parent);
    	   final ViewHolder holder = BaseViewHolder.getOrCreateViewHolder(ViewHolder.class,EUExUtil.getResLayoutID("plugin_pdf_browseritem"), view,
                   parent);
...
//            holder.imageView.setImageResource(watched ? R.drawable.plugin_pdf_browser_item_folder_watched : R.drawable.plugin_pdf_browser_item_folder_open);
            holder.imageView.setImageResource(watched ?   EUExUtil.getResDrawableID("plugin_pdf_browser_item_folder_watched") :
            	  EUExUtil.getResDrawableID("plugin_pdf_browser_item_folder_open"));
          
            holder.info.setText("");
            holder.fileSize.setText("");
        } else {
            final boolean wasRead = SettingsManager.getBookSettings(ap) != null;
//            holder.imageView.setImageResource(wasRead ? R.drawable.plugin_pdf_recent_item_book_watched : R.drawable.browser_item_book);
             holder.imageView.setImageResource(wasRead ? EUExUtil.getResDrawableID("plugin_pdf_recent_item_book_watched") :
             	  EUExUtil.getResDrawableID("plugin_pdf_browser_item_book"));
...
//            fileSize = (TextView) convertView.findViewById(R.id.browserItemfileSize);
            textView = (TextView) convertView.findViewById(EUExUtil.getResIdID("browserItemText"));
            imageView = (ImageView) convertView.findViewById(EUExUtil.getResIdID("browserItemIcon"));
            info = (TextView) convertView.findViewById(EUExUtil.getResIdID("browserItemInfo"));
            fileSize = (TextView) convertView.findViewById(EUExUtil.getResIdID("browserItemfileSize"));
        }
    }
