...
//            addPreferencesFromResource(R.xml.fragment_book);
        	 addPreferencesFromResource(EUExUtil.getResXmlID("plugin_pdf_fragment_book"));
...
//            addPreferencesFromResource(R.xml.fragment_book);
            PreferenceManager.setDefaultValues(this,  EUExUtil.getResXmlID("plugin_pdf_fragment_book"), true);
            addPreferencesFromResource( EUExUtil.getResXmlID("plugin_pdf_fragment_book"));
