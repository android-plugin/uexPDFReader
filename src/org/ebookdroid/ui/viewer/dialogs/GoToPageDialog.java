...
//        actions.connectEditorToAction(editText, R.id.actions_gotoPage);
        ...
        setTitle(EUExUtil.getResStringID("plugin_pdf_dialog_title_goto_page"));
        setContentView(EUExUtil.getResLayoutID("gotopage"));

        final SeekBar seekbar = (SeekBar) findViewById(EUExUtil.getResIdID("seekbar"));
        final EditText editText = (EditText) findViewById(EUExUtil.getResIdID("pageNumberTextEdit"));

        actions.connectViewToAction(EUExUtil.getResIdID("bookmark_add"));
        actions.connectViewToAction(EUExUtil.getResIdID("bookmark_remove_all"));
        actions.connectViewToAction(EUExUtil.getResIdID("bookmark_remove"));
        actions.connectViewToAction(EUExUtil.getResIdID("goToButton"));
        actions.connectEditorToAction(editText, EUExUtil.getResIdID("actions_gotoPage"));
...
//        handler.init(new IViewContainer.DialogBridge(this), seekbar, R.id.seekbar_minus, R.id.seekbar_plus);
        handler.init(new IViewContainer.DialogBridge(this), seekbar, EUExUtil.getResIdID("seekbar_minus"), EUExUtil.getResIdID("seekbar_plus"));
    }
...
//        final ListView bookmarks = (ListView) findViewById(R.id.bookmarks);
        final ListView bookmarks = (ListView) findViewById(EUExUtil.getResIdID("bookmarks"));
...
//        builder.setNegativeButton().show();
        ...
        final ActionDialogBuilder builder = new ActionDialogBuilder(getContext(), actions);
        builder.setTitle(EUExUtil.getResStringID("plugin_pdf_del_bookmark_title"));
        builder.setMessage(EUExUtil.getResStringID("plugin_pdf_del_bookmark_text"));
        builder.setPositiveButton(EUExUtil.getResIdID("actions_removeBookmark"), new Constant("bookmark", bookmark));
        builder.setNegativeButton().show();
    }
...
//        final EditText input = (EditText) LayoutInflater.from(getContext()).inflate(R.layout.plugin_pdf_bookmark_edit, null);
        final EditText input = (EditText) LayoutInflater.from(getContext()).inflate(EUExUtil.getResLayoutID("plugin_pdf_bookmark_edit"), null);
        final ActionDialogBuilder builder = new ActionDialogBuilder(getContext(), actions);
//        builder.setMessage(R.string.add_bookmark_name);
        builder.setMessage(EUExUtil.getResStringID("plugin_pdf_add_bookmark_name"));
...
//            input.setText(context.getString(R.string.text_page) + " " + (viewIndex + offset));
            input.setText(context.getString(EUExUtil.getResStringID("plugin_pdf_text_page")) + " " + (viewIndex + offset));
            input.selectAll();

//            builder.setPositiveButton(R.id.actions_addBookmark, new EditableValue("input", input), new Constant(
//                    "viewIndex", viewIndex));
            builder.setPositiveButton(EUExUtil.getResIdID("actions_addBookmark"), new EditableValue("input", input), new Constant(
                    "viewIndex", viewIndex));
        } else {
//            builder.setTitle(R.string.menu_edit_bookmark);
        	  builder.setTitle(EUExUtil.getResStringID("plugin_pdf_menu_edit_bookmark"));
...
//        builder.setNegativeButton().show();
        ...
        final ActionDialogBuilder builder = new ActionDialogBuilder(getContext(), actions);
        builder.setTitle(EUExUtil.getResStringID("plugin_pdf_clear_bookmarks_title"));
        builder.setMessage(EUExUtil.getResStringID("plugin_pdf_clear_bookmarks_text"));
        builder.setPositiveButton(EUExUtil.getResIdID("actions_deleteAllBookmarks"));
        builder.setNegativeButton().show();
...
//        final EditText text = (EditText) findViewById(R.id.pageNumberTextEdit);
        final EditText text = (EditText) findViewById(EUExUtil.getResIdID("pageNumberTextEdit"));
...
//            final String msg = base.getContext().getString(R.string.bookmark_invalid_page, offset, pageCount - 1 + offset);
        	final String msg = base.getContext().getString(EUExUtil.getResStringID("plugin_pdf_bookmark_invalid_page"), offset, pageCount - 1 + offset);
