...
//        setTitle(R.string.outline_title);
        setTitle(EUExUtil.getResStringID("plugin_pdf_outline_title"));
...
//        actions.getOrCreateAction(R.id.actions_gotoOutlineItem).onItemClick(parent, view, position, id);
        actions.getOrCreateAction(EUExUtil.getResIdID("actions_gotoOutlineItem")).onItemClick(parent, view, position, id);
    }
}
