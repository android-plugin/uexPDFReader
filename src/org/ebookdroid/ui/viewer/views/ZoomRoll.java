...
//        right = BitmapManager.getResource(R.drawable.plugin_pdf_components_zoomroll_right);
//        center = BitmapManager.getResource(R.drawable.plugin_pdf_components_zoomroll_center);
//        serifs = BitmapManager.getResource(R.drawable.plugin_pdf_components_zoomroll_serifs);
        
        left = BitmapManager.getResource(EUExUtil.getResDrawableID("components_zoomroll_left"));
        right = BitmapManager.getResource(EUExUtil.getResDrawableID("plugin_pdf_components_zoomroll_right"));
        center = BitmapManager.getResource(EUExUtil.getResDrawableID("plugin_pdf_components_zoomroll_center"));
        serifs = BitmapManager.getResource(EUExUtil.getResDrawableID("plugin_pdf_components_zoomroll_serifs"));
