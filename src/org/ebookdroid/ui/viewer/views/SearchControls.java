...
//        LayoutInflater.from(parent).inflate(R.layout.plugin_pdf_seach_controls, this, true);
...
//        ActionEx backwardSearch = parent.getController().getOrCreateAction(R.id.actions_doSearchBack);
        ...
        LayoutInflater.from(parent).inflate(EUExUtil.getResLayoutID("plugin_pdf_seach_controls"), this, true);
        m_prevButton = (ImageButton) findViewById(EUExUtil.getResIdID("search_controls_prev"));
        m_nextButton = (ImageButton) findViewById(EUExUtil.getResIdID("search_controls_next"));
        m_edit = (EditText) findViewById(EUExUtil.getResIdID("search_controls_edit"));

        ActionEx forwardSearch = parent.getController().getOrCreateAction(EUExUtil.getResIdID("actions_doSearch"));
        ActionEx backwardSearch = parent.getController().getOrCreateAction(EUExUtil.getResIdID("actions_doSearchBack"));
