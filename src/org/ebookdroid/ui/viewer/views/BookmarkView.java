...
//                actions.getOrCreateAction(R.id.actions_setBookmarkedPage).onClick(BookmarkView.this);
                actions.getOrCreateAction( EUExUtil.getResIdID("actions_setBookmarkedPage")).onClick(BookmarkView.this);
...
//                actions.getOrCreateAction(R.id.bookmark_add).onClick(BookmarkView.this);
            	 actions.getOrCreateAction(  EUExUtil.getResIdID("bookmark_add")).onClick(BookmarkView.this);
