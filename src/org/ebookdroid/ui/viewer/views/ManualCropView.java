...
//        builder.show();
        ...
        final ActionDialogBuilder builder = new ActionDialogBuilder(getContext(), controller);
        builder.setTitle(EUExUtil.getResStringID("plugin_pdf_manual_cropping_title"));
        builder.setItems(ResUtils.getResArrayId("plugin_pdf_list_crop_actions"), controller.getOrCreateAction(EUExUtil.getResIdID("actions_applyCrop")));
        builder.setNegativeButton(EUExUtil.getResStringID("plugin_pdf_manual_cropping_back"));
        builder.show();
...
//        final Drawable d = base.getContext().getResources().getDrawable(R.drawable.plugin_pdf_components_cropper_circle);
        final Drawable d = base.getContext().getResources().getDrawable(EUExUtil.getResDrawableID("plugin_pdf_components_cropper_circle"));
