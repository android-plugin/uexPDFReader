...
//        background = resources.getDrawable(R.drawable.plugin_pdf_viewer_outline_item_background);
//        selected = resources.getDrawable(R.drawable.plugin_pdf_viewer_outline_item_background_selected);
        background = resources.getDrawable( EUExUtil.getResDrawableID("plugin_pdf_viewer_outline_item_background"));
        selected = resources.getDrawable( EUExUtil.getResDrawableID("plugin_pdf_viewer_outline_item_background_selected"));
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
//            container = LayoutInflater.from(context).inflate(R.layout.plugin_pdf_outline_item, parent, false);
        	   container = LayoutInflater.from(context).inflate(EUExUtil.getResLayoutID("plugin_pdf_outline_item"), parent, false);
            firstTime = true;
        } else {
...
//        final TextView pageIndex = (TextView) container.findViewById(R.id.outline_pageindex);
        ...
        final TextView view = (TextView) container.findViewById( EUExUtil.getResIdID("outline_title"));
        final View btn = container.findViewById( EUExUtil.getResIdID("outline_collapse"));
        final View space = container.findViewById( EUExUtil.getResIdID("outline_space"));
        final TextView pageIndex = (TextView) container.findViewById( EUExUtil.getResIdID("outline_pageindex"));
...
//            btn.setBackgroundResource(states[id] == OutlineItemState.EXPANDED ? R.drawable.plugin_pdf_viewer_outline_item_expanded.png
//                    : R.drawable.plugin_pdf_viewer_outline_item_collapsed);
            
            btn.setBackgroundResource(states[id] == OutlineItemState.EXPANDED ?  EUExUtil.getResDrawableID("plugin_pdf_viewer_outline_item_expanded.png")
                    :  EUExUtil.getResDrawableID("plugin_pdf_viewer_outline_item_collapsed"));
        }
